...
export default class Animar {
  ...
  add(element: ?any, attributes: ?any, options: ?any): FullChainObject { // user-provided so can't assume correct type or existance
  ...
  _resolveStartValue(start: ?number, element: HTMLElement, attribute: string, currentChain: ElementMap) {
