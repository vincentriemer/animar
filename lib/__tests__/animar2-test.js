...
describe('_add()', function() {
  ...
  it('should properly handle the elastic easing function', function() {
    var easingFunction = require('../ease').elastic = jest.genMockFn();
    animar._add(testElement, {
      translateX: [12, 24]
    }, {
      easing: 'elastic',
    ...
    expect(easingFunction.mock.calls[0][0]).toEqual(0.5);
  });
